 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-2">
            <a href="/regional/agregar" class="btn btn-block btn-primary btn-flat btn-md">Agregar Regional</a><br />
            </div>
          </div>
           <!-- Main content -->
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Listado de Regionales</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php  
                          foreach($regionales as $data){ ?>
                            <tr>
                                <td><?php echo $data->nombre; ?></td>
                                <td><?php echo $data->responsable; ?></td>
                                <td>
                                    <a href="/regional/editar/<?= $data->id ?>" class="btn btn-flat btn-success btn-xs">Editar</a>
